...
namespace Vaxtaskra.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.SourceSystem = (from i in db.SourceSystems select i).ToList();
        ...
        public ActionResult Create(Product product)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("Create","Product_indexation",new { id = product.ProductID });
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,ProductName,ProductCategoryID,Active")] Product product)
        {
            if (ModelState.IsValid)
            {
